...
const useDepartmentSubmit = (id,data) => {
  ...
  const [handleTap,setHandleTap] =useState("handleDepartmentTap");
...
console.log('id',id)
  ...
  //     handleDepartmentTap("Anglais", true);
  //     setResData({});
  //     setValue("image");
  //     setValue("name_en");
  //     setValue("name_fr");
  ...
  const handleDepartmentTap = (e, value, name) => {
