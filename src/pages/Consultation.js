...
const Consultation = () => {
  ...
  const fetchSubscribers = async (isLoading, searchSubscriber) => {
    try {
      let response;
      response = await ConsultationServices.getAllConsultations();
  ...
  useEffect(() => {
    fetchSubscribers(isLoading); // Appelez la fonction fetchServices pour récupérer les projets au chargement du composant
  ...
  return (
    <>
      ...
      <PageTitle>{"Consultation pages"}</PageTitle>
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell>{"Prenom du patient"}</TableCell>
                <TableCell>{"Date du consultation"}</TableCell>
                <TableCell>{"Heure du consultation"}</TableCell>
                <TableCell>{"Status du consultation"}</TableCell>
